...
import ../src/moepkg/syntax/[tokenizer, syntaxjson]

suite "syntaxjson - jsonNextToken keywords":
  test "true keyword":
...
suite "syntaxjson - jsonNextToken identifiers":
...
suite "syntaxjson - jsonNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxjson - jsonNextToken float numbers":
...
suite "syntaxjson - jsonNextToken string literals":
...
suite "syntaxjson - jsonNextToken key detection":
  test "string as key":
    var g: GeneralTokenizer
...
suite "syntaxjson - jsonNextToken escape sequences":
...
suite "syntaxjson - jsonNextToken operators":
  test "colon operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer(":")
    g.jsonNextToken()
...
suite "syntaxjson - jsonNextToken punctuation":
  test "open brace":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("{")
    g.jsonNextToken()
...
suite "syntaxjson - jsonNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
    g.initGeneralTokenizer(" ")
    g.jsonNextToken()
...
suite "syntaxjson - jsonNextToken EOF":
...
suite "syntaxjson - jsonNextToken complete JSON":
  test "simple object":
    var g: GeneralTokenizer
...
suite "syntaxjson - jsonNextToken edge cases":
...
suite "syntaxjson - jsonNextToken long string literal":
...
suite "syntaxjson - jsonNextToken string continuation":
