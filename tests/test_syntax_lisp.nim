...
import ../src/moepkg/syntax/[tokenizer, syntax_lisp]

suite "syntax_lisp - lispKeywords constant":
...
suite "syntax_lisp - lispNextToken keywords":
  test "defun keyword":
...
suite "syntax_lisp - lispNextToken identifiers":
...
suite "syntax_lisp - lispNextToken numbers":
  test "decimal number":
    var g: GeneralTokenizer
...
suite "syntax_lisp - lispNextToken strings":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntax_lisp - lispNextToken block comments":
...
suite "syntax_lisp - lispNextToken parentheses":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.lispNextToken()
...
suite "syntax_lisp - lispNextToken quote operators":
  test "quote":
    var g: GeneralTokenizer
...
suite "syntax_lisp - lispNextToken character literals":
...
suite "syntax_lisp - lispNextToken vector literal":
  test "vector #(":
    var g: GeneralTokenizer
...
suite "syntax_lisp - lispNextToken whitespace":
  test "spaces":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("   ")
    g.lispNextToken()
...
suite "syntax_lisp - lispNextToken EOF":
  test "empty input":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("")
    g.lispNextToken()
...
suite "syntax_lisp - lispNextToken complete code":
  test "defun form":
    var g: GeneralTokenizer
