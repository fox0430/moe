...
import ../src/moepkg/syntax/[tokenizer, syntax_nim]

suite "syntax_nim - NimKeywords constant":
...
suite "syntax_nim - NimBooleans constant":
...
suite "syntax_nim - NimSpecialVars constant":
...
suite "syntax_nim - NimPragmas constant":
...
suite "syntax_nim - NimBuiltins constant":
...
suite "syntax_nim - NimStdLibs constant":
...
suite "syntax_nim - nimNextToken keywords":
  test "proc keyword":
...
suite "syntax_nim - nimNextToken booleans":
  test "true boolean":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken special vars":
...
suite "syntax_nim - nimNextToken type names":
...
suite "syntax_nim - nimNextToken identifiers":
...
suite "syntax_nim - nimNextToken function names":
...
suite "syntax_nim - nimNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken float numbers":
...
suite "syntax_nim - nimNextToken hex numbers":
  test "hex number":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken octal numbers":
  test "octal number":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken binary numbers":
  test "binary number":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken string literals":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken raw strings":
...
suite "syntax_nim - nimNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.nimNextToken()
...
suite "syntax_nim - nimNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.nimNextToken()
...
suite "syntax_nim - nimNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken escape sequences":
...
suite "syntax_nim - nimNextToken builtins":
  test "echo builtin":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken stdlib":
  test "os stdlib":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken EOF":
...
suite "syntax_nim - nimNextToken complete code":
...
suite "syntax_nim - nimNextToken edge cases":
...
suite "syntax_nim - nimNextToken long string edge cases":
...
suite "syntax_nim - nimNextToken raw data handling":
...
suite "syntax_nim - nimNextToken pragmas":
  test "inline pragma":
    var g: GeneralTokenizer
...
suite "syntax_nim - nimNextToken keyword style insensitivity":
...
suite "syntax_nim - nimNextToken number suffix variations":
...
suite "syntax_nim - nimNextToken identifier with long string":
...
suite "syntax_nim - nimNextToken string continuation":
...
suite "syntax_nim - nimNextToken escape edge cases":
...
suite "syntax_nim - nimNextToken doc comments":
