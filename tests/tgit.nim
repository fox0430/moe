...
"""
    check diffResult.parseGitDiffOutput == @[
      Diff(operation: OperationType.edited, firstLine: 8, lastLine: 8),
      Diff(operation: OperationType.edited, firstLine: 21, lastLine: 21),
    ]
...
"""
    ...
    check diffResult.parseGitDiffOutput == @[
      Diff(operation: OperationType.deleted, firstLine: 19, lastLine: 20),
    ]
