...
import ../src/moepkg/syntax/[tokenizer, syntax_cpp]

suite "syntax_cpp - cppKeywords constant":
...
suite "syntax_cpp - cppNextToken keywords":
  test "class keyword":
...
suite "syntax_cpp - cppNextToken identifiers":
...
suite "syntax_cpp - cppNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntax_cpp - cppNextToken hex numbers":
...
suite "syntax_cpp - cppNextToken float numbers":
...
suite "syntax_cpp - cppNextToken string literals":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntax_cpp - cppNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntax_cpp - cppNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntax_cpp - cppNextToken preprocessor":
...
suite "syntax_cpp - cppNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.cppNextToken()
...
suite "syntax_cpp - cppNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.cppNextToken()
...
suite "syntax_cpp - cppNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntax_cpp - cppNextToken EOF":
...
suite "syntax_cpp - cppNextToken complete code":
...
suite "syntax_cpp - cppNextToken edge cases":
...
suite "syntax_cpp - cppNextToken number suffixes":
...
suite "syntax_cpp - cppNextToken string continuation":
...
suite "syntax_cpp - cppNextToken scope resolution":
...
suite "syntax_cpp - cppNextToken additional edge cases":
...
suite "syntax_cpp - cppNextToken compound operators":
...
suite "syntax_cpp - cppNextToken float edge cases":
...
suite "syntax_cpp - cppNextToken C++ specific":
...
suite "syntax_cpp - cppNextToken doc comments":
