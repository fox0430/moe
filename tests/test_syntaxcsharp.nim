...
import ../src/moepkg/syntax/syntaxcsharp

suite "syntaxcsharp - csharpKeywords constant":
...
suite "syntaxcsharp - csharpNextToken keywords":
  test "class keyword":
...
suite "syntaxcsharp - csharpNextToken identifiers":
...
suite "syntaxcsharp - csharpNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxcsharp - csharpNextToken hex numbers":
...
suite "syntaxcsharp - csharpNextToken float numbers":
...
suite "syntaxcsharp - csharpNextToken string literals":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntaxcsharp - csharpNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntaxcsharp - csharpNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntaxcsharp - csharpNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.csharpNextToken()
...
suite "syntaxcsharp - csharpNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.csharpNextToken()
...
suite "syntaxcsharp - csharpNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntaxcsharp - csharpNextToken EOF":
...
suite "syntaxcsharp - csharpNextToken complete code":
...
suite "syntaxcsharp - csharpNextToken edge cases":
...
suite "syntaxcsharp - csharpNextToken number suffixes":
...
suite "syntaxcsharp - csharpNextToken string continuation":
...
suite "syntaxcsharp - csharpNextToken colon handling":
...
suite "syntaxcsharp - csharpNextToken additional edge cases":
...
suite "syntaxcsharp - csharpNextToken compound operators":
...
suite "syntaxcsharp - csharpNextToken float edge cases":
...
suite "syntaxcsharp - csharpNextToken C# specific":
