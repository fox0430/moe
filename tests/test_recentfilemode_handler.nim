...
## Tests for recentfilemode_handler.nim
...
import ../src/moepkg/recentfilemode {.all.}
import ../src/moepkg/command_handlers/recentfilemode_handler {.all.}
...
suite "recentfilemode_handler: newRecentFileModeHandler":
  test "Create new handler":
    let handler = newRecentFileModeHandler()
    check handler != nil
    check handler.waitingForG == false

suite "recentfilemode_handler: handleRecentFileModeKey - Movement keys":
...
suite "recentfilemode_handler: handleRecentFileModeKey - No-op keys":
...
suite "recentfilemode_handler: handleRecentFileModeKey - gg and G commands":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Mode transitions":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Window navigation":
...
suite "recentfilemode_handler: handleRecentFileModeKey - File opening":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Scroll adjustment":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Unhandled keys":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Empty state":
...
suite "recentfilemode_handler: handleRecentFileModeKey - gg command edge cases":
...
suite "recentfilemode_handler: handleRecentFileModeKey - Boundary conditions":
