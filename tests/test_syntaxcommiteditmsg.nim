...
import ../src/moepkg/syntax/[tokenizer, syntaxcommiteditmsg]

suite "syntaxcommiteditmsg - Comment lines":
...
suite "syntaxcommiteditmsg - Commit message text":
...
suite "syntaxcommiteditmsg - EOF handling":
...
suite "syntaxcommiteditmsg - Multiple lines":
