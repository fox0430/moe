...
import ../src/moepkg/syntax/syntaxfish

suite "syntaxfish - fishKeywords constant":
...
suite "syntaxfish - fishNextToken keywords":
  test "if keyword":
...
suite "syntaxfish - fishNextToken identifiers":
...
suite "syntaxfish - fishNextToken numbers (no highlight)":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxfish - fishNextToken string literals":
...
suite "syntaxfish - fishNextToken single quote no escape":
...
suite "syntaxfish - fishNextToken escape sequences":
...
suite "syntaxfish - fishNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntaxfish - fishNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.fishNextToken()
...
suite "syntaxfish - fishNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.fishNextToken()
...
suite "syntaxfish - fishNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntaxfish - fishNextToken EOF":
...
suite "syntaxfish - fishNextToken complete code":
...
suite "syntaxfish - fishNextToken edge cases":
...
suite "syntaxfish - fishNextToken string continuation":
...
suite "syntaxfish - fishNextToken shebang":
  test "shebang line":
    var g: GeneralTokenizer
