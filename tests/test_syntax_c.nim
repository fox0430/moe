...
import ../src/moepkg/syntax/[tokenizer, syntax_c]

suite "syntax_c - cKeywords constant":
...
suite "syntax_c - cNextToken keywords":
  test "int keyword":
...
suite "syntax_c - cNextToken identifiers":
...
suite "syntax_c - cNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken hex numbers":
...
suite "syntax_c - cNextToken binary numbers":
...
suite "syntax_c - cNextToken octal numbers":
  test "octal number":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken float numbers":
...
suite "syntax_c - cNextToken string literals":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken preprocessor":
...
suite "syntax_c - cNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.cNextToken()
...
suite "syntax_c - cNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.cNextToken()
...
suite "syntax_c - cNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntax_c - cNextToken escape sequences":
...
suite "syntax_c - cNextToken complete code":
...
suite "syntax_c - cNextToken edge cases":
...
suite "syntax_c - cNextToken number suffixes":
...
suite "syntax_c - cNextToken string continuation":
...
suite "syntax_c - cNextToken additional edge cases":
...
suite "syntax_c - cNextToken compound operators":
...
suite "syntax_c - cNextToken float edge cases":
...
suite "syntax_c - cNextToken special cases":
...
suite "syntax_c - cNextToken doc comments":
