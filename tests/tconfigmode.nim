...
const correctBuffer = @[
  ...
  ru"",
  ru"Notification",
  ru"  screenNotifications           false",
  ru"  logNotifications              false",
  ru"  autoBackupScreenNotify        false",
  ru"  autoBackupLogNotify           false",
  ru"  autoSaveScreenNotify          false",
  ru"  autoSaveLogNotify             false",
  ru"  yankScreenNotify              false",
  ru"  yankLogNotify                 false",
  ru"  deleteScreenNotify            false",
  ru"  deleteLogNotify               false",
  ru"  saveScreenNotify              false",
  ru"  saveLogNotify                 false",
  ru"  workspaceScreenNotify         false",
  ru"  workspaceLogNotify            false",
  ru"  quickRunScreenNotify          false",
  ru"  quickRunLogNotify             false",
  ru"  buildOnSaveScreenNotify       false",
  ru"  buildOnSaveLogNotify          false",
  ru"  filerScreenNotify             false",
  ru"  filerLogNotify                false",
  ru"  restoreScreenNotify           false",
  ru"  restoreLogNotify              false",
  ru"",
  ru"Filer",
  ru"  showIcons                     true",
  ru"",
