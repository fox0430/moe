...
suite "syntax_tcl - tclNextToken keywords":
  test "proc keyword":
...
suite "syntax_tcl - tclNextToken identifiers":
...
suite "syntax_tcl - tclNextToken variables":
...
suite "syntax_tcl - tclNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntax_tcl - tclNextToken hex numbers":
...
suite "syntax_tcl - tclNextToken binary numbers":
...
suite "syntax_tcl - tclNextToken octal numbers":
...
suite "syntax_tcl - tclNextToken float numbers":
...
suite "syntax_tcl - tclNextToken string literals":
...
suite "syntax_tcl - tclNextToken escape sequences":
...
suite "syntax_tcl - tclNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntax_tcl - tclNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.tclNextToken()
...
suite "syntax_tcl - tclNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.tclNextToken()
...
suite "syntax_tcl - tclNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntax_tcl - tclNextToken EOF":
...
suite "syntax_tcl - tclNextToken complete code":
  test "set command":
    var g: GeneralTokenizer
...
suite "syntax_tcl - tclNextToken edge cases":
...
suite "syntax_tcl - tclNextToken additional operators":
...
suite "syntax_tcl - getNextToken dispatcher":
...
suite "syntax_tcl - getSourceLanguage":
