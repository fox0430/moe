...
import ../src/moepkg/syntax/[tokenizer, syntax_hyprland]

suite "syntax_hyprland - comments":
  test "hash comment":
...
suite "syntax_hyprland - keywords":
  test "bind keyword":
    var g: GeneralTokenizer
...
suite "syntax_hyprland - booleans":
  test "true":
    var g: GeneralTokenizer
...
suite "syntax_hyprland - variables":
...
suite "syntax_hyprland - strings with escape sequences":
...
suite "syntax_hyprland - section names":
...
suite "syntax_hyprland - punctuation and operators":
...
suite "syntax_hyprland - whitespace":
  test "spaces":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("   ")
    g.hyprlandNextToken()
...
suite "syntax_hyprland - detectLanguage":
  test "hyprland.conf":
