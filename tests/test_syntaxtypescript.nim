...
suite "syntaxtypescript - typescriptKeywords constant":
  ...
  test "typescriptKeywords contains boolean and null values":
    check "true" in typescriptKeywords
    check "false" in typescriptKeywords
    check "null" in typescriptKeywords
    check "undefined" in typescriptKeywords
  ...
  test "typescriptKeywords contains built-in objects":
    check "Object" in typescriptKeywords
    check "String" in typescriptKeywords
    check "Promise" in typescriptKeywords
    check "Map" in typescriptKeywords
    check "Set" in typescriptKeywords
    check "JSON" in typescriptKeywords
    check "RegExp" in typescriptKeywords
  ...
  test "typescriptKeywords contains typed arrays":
    check "Int8Array" in typescriptKeywords
    check "Int16Array" in typescriptKeywords
    check "Int32Array" in typescriptKeywords
    check "Uint8Array" in typescriptKeywords
    check "Uint16Array" in typescriptKeywords
    check "Uint32Array" in typescriptKeywords
    check "Uint8ClampedArray" in typescriptKeywords

suite "syntaxtypescript - typescriptNextToken keywords":
  test "var keyword":
...
suite "syntaxtypescript - typescriptNextToken identifiers":
...
suite "syntaxtypescript - typescriptNextToken object keys":
...
suite "syntaxtypescript - typescriptNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxtypescript - typescriptNextToken hex numbers":
...
suite "syntaxtypescript - typescriptNextToken binary numbers":
...
suite "syntaxtypescript - typescriptNextToken octal numbers":
...
suite "syntaxtypescript - typescriptNextToken BigInt numbers":
  test "decimal BigInt":
    var g: GeneralTokenizer
...
suite "syntaxtypescript - typescriptNextToken float numbers":
...
suite "syntaxtypescript - typescriptNextToken string literals":
...
suite "syntaxtypescript - typescriptNextToken template literals":
...
suite "syntaxtypescript - typescriptNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntaxtypescript - typescriptNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.typescriptNextToken()
...
suite "syntaxtypescript - typescriptNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntaxtypescript - typescriptNextToken EOF":
...
suite "syntaxtypescript - typescriptNextToken template literal interpolation":
...
suite "syntaxtypescript - typescriptNextToken TypeScript-specific syntax":
  ...
  test "generic type":
    ...
    check gtKeyword in tokens # Array, string
  ...
  test "conditional type with infer":
    ...
    check gtKeyword in tokens # type, extends, Promise, infer
...
suite "syntaxtypescript - typescriptNextToken complete TypeScript code":
  ...
  test "async function with Promise type":
    ...
    check gtKeyword in tokens # async, function, Promise, string, return, await, fetch
  ...
  test "union type":
    ...
    check gtKeyword in tokens # let, string, number, null
    check gtOperator in tokens # :, |
...
suite "syntaxtypescript - typescriptNextToken edge cases":
...
suite "syntaxtypescript - typescriptNextToken TSX/JSX mode":
...
suite "syntaxtypescript - typescriptNextToken brace tracking":
...
suite "syntaxtypescript - typescriptNextToken state reset":
...
suite "syntaxtypescript - typescriptNextToken advanced TypeScript patterns":
