...
## Tests for backupmanager_handler.nim
...
import ../src/moepkg/backupmanager {.all.}
import ../src/moepkg/command_handlers/backupmanager_handler {.all.}
...
suite "backupmanager_handler: newBackupManagerHandler":
  test "Create new handler":
    let handler = newBackupManagerHandler()
    check handler != nil
    check handler.waitingForG == false

suite "backupmanager_handler: handleBackupManagerModeKey - Basic movement keys":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Arrow keys":
...
suite "backupmanager_handler: handleBackupManagerModeKey - gg and G commands":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Half page movement":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Mode transitions":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Backup actions":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Window switching":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Unhandled keys":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Edge cases":
...
suite "backupmanager_handler: handleBackupManagerModeKey - Scroll position":
...
suite "backupmanager_handler: BackupManagerResult kinds":
...
suite "backupmanager_handler: Multiple consecutive operations":
...
suite "backupmanager_handler: Single entry state":
...
suite "backupmanager_handler: Small viewport":
...
suite "backupmanager_handler: waitingForG with modifier keys":
