...
"""
    ...
    check tokens(Code) ==
      @[
        ...
        GT(kind: gtKey, start: 4, length: 14, buf: "", pos: 18, state: gtEof),
        ...
        GT(kind: gtKey, start: 26, length: 8, buf: "", pos: 34, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 51, length: 1, buf: "", pos: 52, state: gtEof),
        GT(kind: gtWhitespace, start: 52, length: 5, buf: "", pos: 57, state: gtEof),
        GT(kind: gtKey, start: 57, length: 8, buf: "", pos: 65, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 69, length: 1, buf: "", pos: 70, state: gtEof),
        GT(kind: gtWhitespace, start: 70, length: 5, buf: "", pos: 75, state: gtEof),
        GT(kind: gtKey, start: 75, length: 9, buf: "", pos: 84, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 90, length: 1, buf: "", pos: 91, state: gtEof),
        GT(kind: gtWhitespace, start: 91, length: 5, buf: "", pos: 96, state: gtEof),
        GT(kind: gtKey, start: 96, length: 6, buf: "", pos: 102, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 112, length: 1, buf: "", pos: 113, state: gtEof),
        GT(kind: gtWhitespace, start: 113, length: 3, buf: "", pos: 116, state: gtEof),
        GT(kind: gtKey, start: 116, length: 15, buf: "", pos: 131, state: gtEof),
        ...
        GT(kind: gtKey, start: 139, length: 6, buf: "", pos: 145, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 157, length: 1, buf: "", pos: 158, state: gtEof),
        GT(kind: gtWhitespace, start: 158, length: 5, buf: "", pos: 163, state: gtEof),
        GT(kind: gtKey, start: 163, length: 5, buf: "", pos: 168, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 172, length: 1, buf: "", pos: 173, state: gtEof),
        GT(kind: gtWhitespace, start: 173, length: 5, buf: "", pos: 178, state: gtEof),
        GT(kind: gtKey, start: 178, length: 9, buf: "", pos: 187, state: gtEof),
        ...
        GT(kind: gtKey, start: 197, length: 8, buf: "", pos: 205, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 220, length: 1, buf: "", pos: 221, state: gtEof),
        GT(kind: gtWhitespace, start: 221, length: 7, buf: "", pos: 228, state: gtEof),
        GT(kind: gtKey, start: 228, length: 6, buf: "", pos: 234, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 245, length: 1, buf: "", pos: 246, state: gtEof),
        GT(kind: gtWhitespace, start: 246, length: 7, buf: "", pos: 253, state: gtEof),
        GT(kind: gtKey, start: 253, length: 9, buf: "", pos: 262, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 279, length: 1, buf: "", pos: 280, state: gtEof),
        GT(kind: gtWhitespace, start: 280, length: 3, buf: "", pos: 283, state: gtEof),
        GT(kind: gtKey, start: 283, length: 7, buf: "", pos: 290, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 294, length: 1, buf: "", pos: 295, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 297, length: 1, buf: "", pos: 298, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 300, length: 1, buf: "", pos: 301, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 303, length: 1, buf: "", pos: 304, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 307, length: 1, buf: "", pos: 308, state: gtEof),
        GT(kind: gtWhitespace, start: 308, length: 3, buf: "", pos: 311, state: gtEof),
        GT(kind: gtKey, start: 311, length: 13, buf: "", pos: 324, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 340, length: 1, buf: "", pos: 341, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 348, length: 1, buf: "", pos: 349, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 359, length: 1, buf: "", pos: 360, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 369, length: 1, buf: "", pos: 370, state: gtEof),
        ...
        GT(kind: gtKey, start: 377, length: 5, buf: "", pos: 382, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 393, length: 1, buf: "", pos: 394, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 401, length: 1, buf: "", pos: 402, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 404, length: 1, buf: "", pos: 405, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 412, length: 1, buf: "", pos: 413, state: gtEof),
        GT(kind: gtWhitespace, start: 413, length: 3, buf: "", pos: 416, state: gtEof),
        GT(kind: gtKey, start: 416, length: 20, buf: "", pos: 436, state: gtEof),
        ...
        GT(kind: gtPunctuation, start: 470, length: 1, buf: "", pos: 471, state: gtNone),
        GT(kind: gtWhitespace, start: 471, length: 3, buf: "", pos: 474, state: gtNone),
        GT(kind: gtKey, start: 474, length: 9, buf: "", pos: 483, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 514, length: 1, buf: "", pos: 515, state: gtNone),
        GT(kind: gtWhitespace, start: 515, length: 3, buf: "", pos: 518, state: gtNone),
        GT(kind: gtKey, start: 518, length: 20, buf: "", pos: 538, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 587, length: 1, buf: "", pos: 588, state: gtNone),
        GT(kind: gtWhitespace, start: 588, length: 3, buf: "", pos: 591, state: gtNone),
        GT(kind: gtKey, start: 591, length: 13, buf: "", pos: 604, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 625, length: 1, buf: "", pos: 626, state: gtNone),
        GT(kind: gtWhitespace, start: 626, length: 3, buf: "", pos: 629, state: gtNone),
        GT(kind: gtKey, start: 629, length: 21, buf: "", pos: 650, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 659, length: 1, buf: "", pos: 660, state: gtNone),
        GT(kind: gtWhitespace, start: 660, length: 3, buf: "", pos: 663, state: gtNone),
        GT(kind: gtKey, start: 663, length: 18, buf: "", pos: 681, state: gtNone),
        ...
        GT(kind: gtKey, start: 689, length: 14, buf: "", pos: 703, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 707, length: 1, buf: "", pos: 708, state: gtNone),
        GT(kind: gtWhitespace, start: 708, length: 5, buf: "", pos: 713, state: gtNone),
        GT(kind: gtKey, start: 713, length: 13, buf: "", pos: 726, state: gtNone),
        ...
        GT(kind: gtPunctuation, start: 734, length: 1, buf: "", pos: 735, state: gtNone),
        GT(kind: gtWhitespace, start: 735, length: 3, buf: "", pos: 738, state: gtNone),
        GT(kind: gtKey, start: 738, length: 14, buf: "", pos: 752, state: gtNone),
        ...
        GT(kind: gtKey, start: 760, length: 8, buf: "", pos: 768, state: gtNone),
        ...
        GT(kind: gtKey, start: 778, length: 8, buf: "", pos: 786, state: gtNone),
        ...
        GT(kind: gtKey, start: 798, length: 8, buf: "", pos: 806, state: gtNone),
        ...
        GT(kind: gtKey, start: 820, length: 8, buf: "", pos: 828, state: gtNone),
        ...
        GT(kind: gtKey, start: 844, length: 8, buf: "", pos: 852, state: gtNone),
  ...
  test "Key highlighting":
    ...
    # Check that "name" is recognized as gtKey
    var nameToken: GT
    var foundNameKey = false
    for token in tokenList:
      let content = Code[token.start ..< token.start + token.length]
      if content == "\"name\"":
        nameToken = token
        foundNameKey = true
        break
    ...
    check foundNameKey
    check nameToken.kind == gtKey

    # Check that "John" is recognized as gtStringLit
    var johnToken: GT
    var foundJohnValue = false
    for token in tokenList:
      let content = Code[token.start ..< token.start + token.length]
      if content == "\"John\"":
        johnToken = token
    ...
    check foundJohnValue
    check johnToken.kind == gtStringLit

    # Check that "age" is recognized as gtKey
    var ageToken: GT
    var foundAgeKey = false
    for token in tokenList:
      let content = Code[token.start ..< token.start + token.length]
      if content == "\"age\"":
        ageToken = token
    ...
    check foundAgeKey
    check ageToken.kind == gtKey

    # Check that "active" is recognized as gtKey
    var activeToken: GT
    ...
    check foundActiveKey
    check activeToken.kind == gtKey

  test "Nested object key highlighting":
    const Code = """{"user": {"profile": {"name": "Alice"}}}"""
    ...
    # Should find 3 keys: "user", "profile", "name"
    check keyCount == 3
