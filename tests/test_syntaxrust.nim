...
import ../src/moepkg/syntax/syntaxrust

suite "syntaxrust - rustKeywords constant":
...
suite "syntaxrust - rustBuiltins constant":
...
suite "syntaxrust - rustNextToken keywords":
  test "fn keyword":
...
suite "syntaxrust - rustNextToken booleans":
  test "true boolean":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken builtins":
...
suite "syntaxrust - rustNextToken identifiers":
...
suite "syntaxrust - rustNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken hex numbers":
...
suite "syntaxrust - rustNextToken binary numbers":
...
suite "syntaxrust - rustNextToken octal numbers":
...
suite "syntaxrust - rustNextToken float numbers":
...
suite "syntaxrust - rustNextToken string literals":
  test "simple string":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken lifetimes":
...
suite "syntaxrust - rustNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.rustNextToken()
...
suite "syntaxrust - rustNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntaxrust - rustNextToken escape sequences":
...
suite "syntaxrust - rustNextToken EOF":
...
suite "syntaxrust - rustNextToken complete code":
...
suite "syntaxrust - rustNextToken edge cases":
...
suite "syntaxrust - rustNextToken number suffixes":
...
suite "syntaxrust - rustNextToken string continuation":
...
suite "syntaxrust - rustNextToken compound operators":
...
suite "syntaxrust - rustNextToken range operators":
  test "range operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("..")
    g.rustNextToken()
...
suite "syntaxrust - rustNextToken special cases":
