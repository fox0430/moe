...
suite "highlite - TokenClass enum":
...
suite "highlite - SourceLanguage enum":
...
suite "highlite - sourceLanguageToStr":
...
suite "highlite - getSourceLanguage":
...
suite "highlite - initGeneralTokenizer":
  ...
  test "initGeneralTokenizer skips initial whitespace":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("   hello")
    check g.pos == 3

  test "initGeneralTokenizer skips tabs":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("\t\thello")
    check g.pos == 2

  test "initGeneralTokenizer skips mixed whitespace":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("  \t  hello")
    check g.pos == 5
...
suite "highlite - getNextToken with langNim":
...
suite "highlite - getNextToken with langRust":
...
suite "highlite - getNextToken with langPython":
...
suite "highlite - getNextToken with langJavaScript":
...
suite "highlite - getNextToken with langC":
...
suite "highlite - getNextToken with langHtml":
...
suite "highlite - getNextToken with langJson":
...
suite "highlite - getNextToken with langYaml":
...
suite "highlite - getNextToken with langToml":
...
suite "highlite - getNextToken with langShell":
...
suite "highlite - getNextToken with langMarkdown":
...
suite "highlite - getNextToken iteration":
...
suite "highlite - GeneralTokenizer state":
...
suite "highlite - langNone behavior":
...
suite "highlite - getNextToken with langTypeScript":
...
suite "highlite - getNextToken with langTsx":
...
suite "highlite - getNextToken with langJsx":
...
suite "highlite - getNextToken with langCpp":
  test "getNextToken tokenizes C++ keywords":
    var g: GeneralTokenizer
...
suite "highlite - getNextToken with langCsharp":
  test "getNextToken tokenizes C# keywords":
    var g: GeneralTokenizer
...
suite "highlite - getNextToken with langHaskell":
...
suite "highlite - getNextToken with langJava":
...
suite "highlite - getNextToken with langAstro":
...
suite "highlite - generalNumber edge cases":
...
suite "highlite - generalStrLit edge cases":
...
suite "highlite - UTF-8 and special characters":
...
suite "highlite - multi-line token handling":
...
suite "highlite - empty and edge input":
...
suite "highlite - token extraction":
...
suite "highlite - all TokenClass values used":
