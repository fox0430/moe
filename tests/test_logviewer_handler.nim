...
## Tests for logviewer_handler.nim
...
import ../src/moepkg/command_handlers/logviewer_handler {.all.}
...
suite "logviewer_handler: newLogViewerHandler":
  test "Create new handler":
    let handler = newLogViewerHandler()
    check handler != nil
    check handler.waitingForG == false

suite "logviewer_handler: handleLogViewerModeKey - Basic movement keys":
...
suite "logviewer_handler: handleLogViewerModeKey - Arrow keys":
...
suite "logviewer_handler: handleLogViewerModeKey - Line position keys":
...
suite "logviewer_handler: handleLogViewerModeKey - gg and G commands":
...
suite "logviewer_handler: handleLogViewerModeKey - Half page and full page movement":
...
suite "logviewer_handler: handleLogViewerModeKey - Word motion":
...
suite "logviewer_handler: handleLogViewerModeKey - Paragraph motion":
...
suite "logviewer_handler: handleLogViewerModeKey - Mode transitions":
...
suite "logviewer_handler: handleLogViewerModeKey - Search navigation":
...
suite "logviewer_handler: handleLogViewerModeKey - Unhandled keys":
...
suite "logviewer_handler: handleLogViewerModeKey - Edge cases":
...
suite "logviewer_handler: handleLogViewerModeKey - Word motion edge cases":
...
suite "logviewer_handler: handleLogViewerModeKey - Search edge cases":
...
suite "logviewer_handler: handleLogViewerModeKey - Paragraph motion edge cases":
