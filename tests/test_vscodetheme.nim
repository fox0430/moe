...
suite "vscodetheme - isCurrentVsCodeThemePackage":
...
suite "vscodetheme - makeColorThemeFromVSCodeThemeFile":
...
suite "vscodetheme - vsCodeSettingsFilePath":
...
suite "vscodetheme - vsCodeUserExtensionsDir":
...
suite "vscodetheme - vsCodeDefaultExtensionsDir":
