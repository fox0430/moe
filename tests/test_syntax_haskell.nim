...
import ../src/moepkg/syntax/[tokenizer, syntax_haskell]

suite "syntax_haskell - haskellKeywords constant":
...
suite "syntax_haskell - haskellNextToken keywords":
  test "if keyword":
...
suite "syntax_haskell - haskellNextToken identifiers":
...
suite "syntax_haskell - haskellNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntax_haskell - haskellNextToken hex numbers":
...
suite "syntax_haskell - haskellNextToken binary numbers":
...
suite "syntax_haskell - haskellNextToken octal numbers":
...
suite "syntax_haskell - haskellNextToken float numbers":
...
suite "syntax_haskell - haskellNextToken string literals":
...
suite "syntax_haskell - haskellNextToken character literals":
  test "simple char":
    var g: GeneralTokenizer
...
suite "syntax_haskell - haskellNextToken escape sequences":
...
suite "syntax_haskell - haskellNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntax_haskell - haskellNextToken operators":
  test "plus operator":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("+")
    g.haskellNextToken()
...
suite "syntax_haskell - haskellNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.haskellNextToken()
...
suite "syntax_haskell - haskellNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntax_haskell - haskellNextToken EOF":
...
suite "syntax_haskell - haskellNextToken complete code":
...
suite "syntax_haskell - haskellNextToken edge cases":
...
suite "syntax_haskell - haskellNextToken string continuation":
