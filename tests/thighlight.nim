...
suite "highlight: initHighlight":
  ...
  test """Highlight "echo \"""":
    ...
    discard initHighlight(buffer, ReservedWords, SourceLanguage.langNim)
  ...
  test "Only '/' in Clang":
    ...
    let
      buffer = @["/"].toSeqRunes
      highlight = initHighlight(buffer, EmptyReservedWords, SourceLanguage.langC)
  ...
  test "initHighlight shell script (Fix #1166)":
    ...
    let
      ...
      highlight = initHighlight(buffer, ReservedWords, SourceLanguage.langShell)
  ...
  test "Nim pragma":
    ...
    let
      buffer = @[Code].toSeqRunes
      highlight = initHighlight(buffer, ReservedWords, SourceLanguage.langNim)
  ...
  test "Fix #1524":
    ...
    let
      buffer = @[Code].toSeqRunes
      highlight = initHighlight(buffer, ReservedWords, SourceLanguage.langYaml)
...
suite "highlight: overwrite":
  ...
  test "Basic":
    ...
    const Code = "　"
    let buffer = @[Code].toSeqRunes
    var highlight = initHighlight(buffer, ReservedWords, SourceLanguage.langNone)
...
suite "parseReservedWord":
  ...
  test "1 TODO":
    check parseReservedWord(
      "# hello TODO world", ReservedWords, EditorColorPairIndex.default
    ).toSeq ==
      @[
  ...
  test "2 TODO":
    check parseReservedWord(
      "# hello TODO world TODO", ReservedWords, EditorColorPairIndex.default
    ).toSeq ==
      @[
        ("# hello ", EditorColorPairIndex.default),
        ("TODO", EditorColorPairIndex.reservedWord),
  ...
  test "edge TODO":
    check parseReservedWord(
      "TODO hello TODO", ReservedWords, EditorColorPairIndex.default
    ).toSeq ==
      @[
        ("", EditorColorPairIndex.default),
        ("TODO", EditorColorPairIndex.reservedWord),
  ...
  test "TODO and WIP and NOTE":
    check parseReservedWord(
      "hello TODO WIP NOTE world", ReservedWords, EditorColorPairIndex.default
    ).toSeq ==
      @[
        ("hello ", EditorColorPairIndex.default),
        ("TODO", EditorColorPairIndex.reservedWord),
  ...
  test "no whitespace":
    check parseReservedWord(
      "TODOWIPNOTETODOWIPNOTE", ReservedWords, EditorColorPairIndex.default
    ).toSeq ==
      @[
        ("", EditorColorPairIndex.default),
        ("TODO", EditorColorPairIndex.reservedWord),
