...
import ../src/moepkg/syntax/syntaxpython

suite "syntaxpython - pythonKeywords constant":
...
suite "syntaxpython - pythonNextToken keywords":
  test "def keyword":
...
suite "syntaxpython - pythonNextToken identifiers":
...
suite "syntaxpython - pythonNextToken decimal numbers":
  test "simple decimal":
    var g: GeneralTokenizer
...
suite "syntaxpython - pythonNextToken hex numbers":
...
suite "syntaxpython - pythonNextToken binary numbers":
...
suite "syntaxpython - pythonNextToken octal numbers":
  test "octal number":
    var g: GeneralTokenizer
...
suite "syntaxpython - pythonNextToken float numbers":
...
suite "syntaxpython - pythonNextToken string literals":
...
suite "syntaxpython - pythonNextToken string escape sequences":
...
suite "syntaxpython - pythonNextToken comments":
  test "line comment":
    var g: GeneralTokenizer
...
suite "syntaxpython - pythonNextToken punctuation":
  test "open paren":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("(")
    g.pythonNextToken()
...
suite "syntaxpython - pythonNextToken whitespace":
  test "single space":
    var g: GeneralTokenizer
...
suite "syntaxpython - pythonNextToken EOF":
...
suite "syntaxpython - pythonNextToken complete code":
...
suite "syntaxpython - pythonNextToken edge cases":
...
suite "syntaxpython - pythonNextToken string continuation":
...
suite "syntaxpython - pythonNextToken decorator syntax":
...
suite "syntaxpython - pythonNextToken modern Python syntax":
  test "walrus operator":
    var g: GeneralTokenizer
...
suite "syntaxpython - pythonNextToken boolean and None":
...
suite "syntaxpython - pythonNextToken special characters":
