...
import ../src/moepkg/syntax/[tokenizer, syntaxgitrebasetodo]

suite "syntaxgitrebasetodo - Comment lines":
...
suite "syntaxgitrebasetodo - Command lines":
...
suite "syntaxgitrebasetodo - Special commands":
...
suite "syntaxgitrebasetodo - EOF handling":
...
suite "syntaxgitrebasetodo - Empty and unknown lines":
  test "empty line":
    var g: GeneralTokenizer
    g.initGeneralTokenizer("\n")
    g.gitRebaseTodoNextToken()
...
suite "syntaxgitrebasetodo - Commit message starting with #":
...
suite "syntaxgitrebasetodo - Multiple lines":
