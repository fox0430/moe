...
import ../src/moepkg/syntax/[tokenizer, syntax_html]

suite "syntax_html - htmlKeywords constant":
...
suite "syntax_html - htmlNextToken tag start":
...
suite "syntax_html - htmlNextToken tag end":
...
suite "syntax_html - htmlNextToken tag names":
...
suite "syntax_html - htmlNextToken attributes":
...
suite "syntax_html - htmlNextToken comments":
  test "HTML comment":
    var g: GeneralTokenizer
...
suite "syntax_html - htmlNextToken whitespace":
...
suite "syntax_html - htmlNextToken EOF":
...
suite "syntax_html - htmlNextToken complete HTML":
  test "simple tag":
    var g: GeneralTokenizer
