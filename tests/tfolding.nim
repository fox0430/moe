...
suite "folding: find":
  ...
  test "Not found":
    let r = @[FoldingRange(first: 0, last: 2), FoldingRange(first: 5, last: 6)]
...
suite "folding: remove with FoldingRange":
  ...
  test "Not found":
    var r = @[FoldingRange(first: 0, last: 2), FoldingRange(first: 5, last: 6)]
...
suite "folding: removeAll with FoldingRange":
  ...
  test "Not found":
    var r = @[FoldingRange(first: 3, last: 5), FoldingRange(first: 5, last: 6)]
    r.removeAll(FoldingRange(first: 1, last: 2))

    check r == @[FoldingRange(first: 3, last: 5), FoldingRange(first: 5, last: 6)]
...
suite "folding: add":
  ...
  test "Basic 2":
    var r = @[FoldingRange(first: 2, last: 3), FoldingRange(first: 6, last: 7)]
  ...
  test "Basic 4":
    var r = @[FoldingRange(first: 3, last: 4)]

    r.add FoldingRange(first: 0, last: 4)
    check r == @[FoldingRange(first: 0, last: 4), FoldingRange(first: 3, last: 4)]

  test "Basic 5":
    var r = @[FoldingRange(first: 3, last: 4)]

    r.add FoldingRange(first: 0, last: 5)
    check r == @[FoldingRange(first: 0, last: 5), FoldingRange(first: 3, last: 4)]

  test "Basic 6":
    var r = @[FoldingRange(first: 3, last: 4), FoldingRange(first: 6, last: 7)]
  ...
  test "Same start":
    ...
    check r == @[FoldingRange(first: 1, last: 3), FoldingRange(first: 1, last: 2)]
