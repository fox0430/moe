...
suite "callhierarchyviewer: initCallHierarchyViewBuffer":
  test "Prepare calls":
    ...
    check initCallHierarchyViewBuffer(CallHierarchyType.prepare, items).get ==
      @[
        "Prepare Call", "", "name0 detail0 /home/user/app/src/test0.rs 0 1",
  ...
  test "Incoming calls":
    ...
    check initCallHierarchyViewBuffer(CallHierarchyType.incoming, items).get ==
      @[
        "Incoming Call", "", "name0 detail0 /home/user/app/src/test0.rs 0 1",
        "name1 detail1 /home/user/app/src/test1.rs 8 9",
      ].toSeqRunes
  ...
  test "Outgoing calls":
    ...
    check initCallHierarchyViewBuffer(CallHierarchyType.outgoing, items).get ==
      @[
        "Outgoing Call", "", "name0 detail0 /home/user/app/src/test0.rs 0 1",
        "name1 detail1 /home/user/app/src/test1.rs 8 9",
      ].toSeqRunes

suite "callhierarchyviewer: parseDestinationLine":
  test "Basic":
    check parseDestinationLine(ru"name0 detail0 /home/user/app/src/test0.rs 0 1").get ==
      (ru"/home/user/app/src/test0.rs", 0, 1)

  test "Basic 2":
    check parseDestinationLine(ru"name2 detail2 /home/user/app/src/test0.rs 100 20").get ==
      (ru"/home/user/app/src/test0.rs", 100, 20)

  test "Basic 3":
    check parseDestinationLine(
      ru"name2 this is log detail /home/user/app/src/test0.rs 10 0"
    ).get == (ru"/home/user/app/src/test0.rs", 10, 0)
