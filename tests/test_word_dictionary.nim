...
import ../src/moepkg/word_dictionary

suite "word_dictionary: contains":
  test "Basic":
...
suite "word_dictionary: incUsage":
  test "Basic":
    var d: WordDictionary
    d["abc"] = 0
...
suite "word_dictionary: enumerateWords":
  test "Basic":
    var r: seq[string]
...
suite "word_dictionary: getLanguageKeywords":
  test "C":
