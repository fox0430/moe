...
proc handleRecentFileModeKeyCombo(e: Editor, keyCombo: KeyCombo): bool =
  ...
  of hrQuit, hrCloseWindow, hrGotoLine, hrVSplit, hrHSplit, hrNew, hrVnew, hrEnew,
      ...
      hrRecoveryManagerRestore, hrRecoveryManagerToggleReviewed,
      hrRecoveryManagerDiscard, hrRecoveryManagerRefresh, hrRecoveryManagerQuit,
      hrEnterRecoveryManager, hrDiffViewerQuit, hrDiffViewerToggleView,
      hrDiffViewerToggleWord, hrRecentFile, hrNextWindow, hrPrevWindow,
      ...
      hrLspRename, hrLspSelectionRange, hrLspDocumentLink, hrShellCommand, hrFilter,
      hrBackground, hrJumpList, hrChanges, hrBuild, hrDebug, hrDebugViewerQuit,
      hrConfig, hrConfigQuit, hrConfigSaveConfig, hrPutConfigFile, hrTheme, hrLspLog,
      hrLspFormat, hrLspRestart, hrLspFold, hrLspExecuteCommand, hrSubstitute,
      hrDeleteLines, hrMan, hrReferencesQuit, hrReferencesJumpTo, hrDocumentSymbolQuit,
      ...
      hrMapRemove, hrMapClear, hrMapList, hrPlaybackMacro, hrUndo, hrRedo, hrJobs:
