...
proc handleRecentFileModeKeyCombo(e: Editor, keyCombo: KeyCombo): bool =
  ...
  of hrQuit, hrCloseWindow, hrGotoLine, hrVSplit, hrHSplit, hrNew, hrVnew, hrEnew,
      ...
      hrRecoveryManagerRestore, hrRecoveryManagerDiscard, hrRecoveryManagerRefresh,
      hrRecoveryManagerQuit, hrEnterRecoveryManager, hrDiffViewerQuit,
      hrDiffViewerToggleView, hrDiffViewerToggleWord, hrRecentFile, hrNextWindow,
      hrPrevWindow, hrMoveWindowLeft, hrMoveWindowDown, hrMoveWindowUp,
