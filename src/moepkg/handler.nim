...
import
  ...
  quick_run_utils, command_completion, build, render_utils, tab_line, clipboard_backend,
  git_cache, cursor_util, syntax_checker, background_process, key_router, pending_input,
  visible_rows, viewer_mode, frontend_input, hover_popup, encoding, unicode_utils,
...
proc handleRecentFileModeKeyCombo(e: Editor, keyCombo: KeyCombo): bool =
  ...
  of hrQuit, hrCloseWindow, hrGotoLine, hrVSplit, hrHSplit, hrNew, hrVnew, hrEnew,
      ...
      hrDiffViewerQuit, hrRecentFile, hrNextWindow, hrPrevWindow,
