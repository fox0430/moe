...
const
  ...
  DefaultForegroundColor* = Color(index: termDefaultForeground, rgb: TerminalDefaultRgb)
  DefaultBackgroundColor* = Color(index: termDefaultBackground, rgb: TerminalDefaultRgb)
...
proc rgbToColor8*(originRgb: Rgb): Color8 =
  ...
  if originRgb.isTermDefaultColor:
    return Color8.default
...
proc downgrade*(rgb: Rgb, mode: ColorMode): Rgb =
  ...
  case mode
  of ColorMode.c8: rgb.rgbToColor8.rgb
  of ColorMode.c16: rgb.rgbToColor16.rgb
  of ColorMode.c256: rgb.rgbToColor256.rgb
  else: rgb
  ...
  let
    fg: int16 =
      if foreground.isTermDefaultColor:
        ...
        case colorMode
        of ColorMode.c8: foreground.rgb.rgbToColor8.int16
        of ColorMode.c16: foreground.rgb.rgbToColor16.int16
        of ColorMode.c256: foreground.rgb.rgbToColor256.int16
    ...
    bg: int16 =
      if background.isTermDefaultColor:
        ...
        case colorMode
        of ColorMode.c8: background.rgb.rgbToColor8.int16
        of ColorMode.c16: background.rgb.rgbToColor16.int16
        of ColorMode.c256: background.rgb.rgbToColor256.int16
        else: background.index.int16

  return initNcursesColorPair(pairIndex.int, fg, bg)

proc initColorPair*(
    pairIndex: EditorColorPairIndex, colorMode: ColorMode, pair: ColorPair
): Result[(), string] =
