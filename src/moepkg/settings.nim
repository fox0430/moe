...
proc generateTomlConfigStr*(settings: EditorSettings): string =
  ...
  buffer.add fmt "statusLine = {$settings.statusLine.enable}"
  buffer.add fmt "tabLine = {$settings.tabLine.useTab}"
  ...
  buffer.add fmt "multipleStatusBar = {$settings.statusLine.multipleStatusLine}"
  buffer.add fmt "merge = {$settings.statusLine.merge }"
  buffer.add fmt "mode = {$settings.statusLine.mode }"
  buffer.add fmt "filename = {$settings.statusLine.filename}"
  buffer.add fmt "chanedMark = {$settings.statusLine.chanedMark}"
  buffer.add fmt "line = {$settings.statusLine.line}"
  buffer.add fmt "column = {$settings.statusLine.column}"
  buffer.add fmt "encoding = {$settings.statusLine.characterEncoding}"
  buffer.add fmt "language = {$settings.statusLine.language}"
  buffer.add fmt "directory = {$settings.statusLine.directory}"
  buffer.add fmt "gitbranchName = {$settings.statusLine.gitbranchName}"
  buffer.add fmt "showGitInactive = {$settings.statusLine.showGitInactive}"
  buffer.add fmt "showModeInactive = {$settings.statusLine.showModeInactive}"

  buffer.add fmt "[WorkSpace]"
  buffer.add fmt "workSpaceLine = {$settings.workSpace.workSpaceLine}"

  buffer.add fmt "[Highlight]"
  buffer.add fmt "currentLine = {$settings.view.highlightCurrentLine}"
  ...
  if settings.quickRunSettings.command.len > 0:
    buffer.add fmt "command = {$settings.quickRunSettings.command}"
  ...
  buffer.add fmt "editorBg = {$theme.editorBg}"
  buffer.add fmt "lineNum = {$theme.lineNum}"
  buffer.add fmt "lineNumBg = {$theme.lineNumBg}"
  buffer.add fmt "currentLineNum = {$theme.currentLineNum}"
  buffer.add fmt "currentLineNumBg = {$theme.currentLineNumBg}"
  buffer.add fmt "statusLineNormalMode = {$theme.statusLineNormalMode}"
  buffer.add fmt "statusLineNormalModeBg = {$theme.statusLineNormalModeBg}"
  buffer.add fmt "statusLineModeNormalMode = {$theme.statusLineNormalMode}"
  buffer.add fmt "statusLineModeNormalModeBg = {$theme.statusLineNormalModeBg}"
  buffer.add fmt "statusLineNormalModeInactive = {$theme.statusLineNormalModeInactive}"
  buffer.add fmt "statusLineNormalModeInactiveBg = {$theme.statusLineNormalModeInactiveBg}"
  buffer.add fmt "statusLineInsertMode = {$theme.statusLineInsertMode}"
  buffer.add fmt "statusLineInsertModeBg = {$theme.statusLineInsertModeBg}"
  buffer.add fmt "statusLineModeInsertMode = {$theme.statusLineModeInsertMode}"
  buffer.add fmt "statusLineModeInsertModeBg = {$theme.statusLineModeInsertModeBg}"
  buffer.add fmt "statusLineInsertModeInactive = {$theme.statusLineInsertModeInactive}"
  buffer.add fmt "statusLineInsertModeInactiveBg = {$theme.statusLineInsertModeInactiveBg}"
  buffer.add fmt "statusLineVisualMode = {$theme.statusLineVisualMode}"
  buffer.add fmt "statusLineVisualModeBg = {$theme.statusLineVisualModeBg}"
  buffer.add fmt "statusLineModeVisualMode = {$theme.statusLineModeVisualMode}"
  buffer.add fmt "statusLineModeVisualModeBg = {$theme.statusLineModeVisualModeBg}"
  buffer.add fmt "statusLineVisualModeInactive = {$theme.statusLineVisualModeInactive}"
  buffer.add fmt "statusLineVisualModeInactiveBg = {$theme.statusLineVisualModeInactiveBg}"
  buffer.add fmt "statusLineReplaceMode = {$theme.statusLineReplaceMode}"
  buffer.add fmt "statusLineReplaceModeBg = {$theme.statusLineReplaceModeBg}"
  buffer.add fmt "statusLineModeReplaceMode = {$theme.statusLineModeReplaceMode}"
  buffer.add fmt "statusLineModeReplaceModeBg = {$theme.statusLineModeReplaceModeBg}"
  buffer.add fmt "statusLineReplaceModeInactive = {$theme.statusLineReplaceModeInactive}"
  buffer.add fmt "statusLineReplaceModeInactiveBg = {$theme.statusLineReplaceModeInactiveBg}"
  buffer.add fmt "statusLineFilerMode = {$theme.statusLineFilerMode}"
  buffer.add fmt "statusLineFilerModeBg = {$theme.statusLineFilerModeBg}"
  buffer.add fmt "statusLineModeFilerMode = {$theme.statusLineModeFilerMode}"
  buffer.add fmt "statusLineModeFilerModeBg = {$theme.statusLineModeFilerModeBg}"
  buffer.add fmt "statusLineFilerModeInactive = {$theme.statusLineFilerModeInactive}"
  buffer.add fmt "statusLineFilerModeInactiveBg = {$theme.statusLineFilerModeInactiveBg}"
  buffer.add fmt "statusLineExMode = {$theme.statusLineExMode}"
  buffer.add fmt "statusLineExModeBg = {$theme.statusLineExModeBg}"
  buffer.add fmt "statusLineModeExMode = {$theme.statusLineModeExMode}"
  buffer.add fmt "statusLineModeExModeBg = {$theme.statusLineModeExModeBg}"
  buffer.add fmt "statusLineExModeInactive = {$theme.statusLineExModeInactive}"
  buffer.add fmt "statusLineExModeInactiveBg = {$theme.statusLineExModeInactiveBg}"
  buffer.add fmt "statusLineGitBranch = {$theme.statusLineGitBranch}"
  buffer.add fmt "statusLineGitBranchBg = {$theme.statusLineGitBranchBg}"
  buffer.add fmt "tab = {$theme.tab}"
  buffer.add fmt "tabBg = {$theme.tabBg}"
  buffer.add fmt "currentTab = {$theme.currentTab}"
  buffer.add fmt "currentTabBg = {$theme.currentTabBg}"
  buffer.add fmt "commandBar = {$theme.commandBar}"
  buffer.add fmt "commandBarBg = {$theme.currentTabBg}"
  buffer.add fmt "errorMessage = {$theme.errorMessage}"
  buffer.add fmt "errorMessageBg = {$theme.errorMessageBg}"
  buffer.add fmt "searchResult = {$theme.searchResult}"
  buffer.add fmt "searchResultBg = {$theme.searchResultBg}"
  buffer.add fmt "visualMode = {$theme.visualMode}"
  buffer.add fmt "visualModeBg = {$theme.visualModeBg}"
  buffer.add fmt "defaultChar = {$theme.defaultChar}"
  buffer.add fmt "gtKeyword = {$theme.gtKeyword}"
  buffer.add fmt "gtFunctionName = {$theme.gtFunctionName}"
  buffer.add fmt "gtBoolean = {$theme.gtBoolean}"
  buffer.add fmt "gtStringLit = {$theme.gtStringLit}"
  buffer.add fmt "gtSpecialVar = {$theme.gtSpecialVar}"
  buffer.add fmt "gtBuiltin = {$theme.gtBuiltin}"
  buffer.add fmt "gtDecNumber = {$theme.gtDecNumber}"
  buffer.add fmt "gtComment = {$theme.gtComment}"
  buffer.add fmt "gtLongComment = {$theme.gtLongComment}"
  buffer.add fmt "gtWhitespace = {$theme.gtWhitespace}"
  buffer.add fmt "gtPreprocessor = {$theme.gtPreprocessor}"
  buffer.add fmt "currentFile = {$theme.currentFile}"
  buffer.add fmt "currentFileBg = {$theme.currentFileBg}"
  buffer.add fmt "file = {$theme.file}"
  buffer.add fmt "fileBg = {$theme.fileBg}"
  buffer.add fmt "dir = {$theme.dir}"
  buffer.add fmt "dirBg = {$theme.dirBg}"
  buffer.add fmt "pcLink = {$theme.pcLink}"
  buffer.add fmt "pcLinkBg = {$theme.pcLinkBg}"
  buffer.add fmt "popUpWindow = {$theme.popUpWindow}"
  buffer.add fmt "popUpWindowBg = {$theme.popUpWindowBg}"
  buffer.add fmt "popUpWinCurrentLine = {$theme.popUpWinCurrentLine}"
  buffer.add fmt "popUpWinCurrentLineBg = {$theme.popUpWinCurrentLineBg}"
  buffer.add fmt "replaceText = {$theme.replaceText}"
  buffer.add fmt "replaceTextBg = {$theme.replaceTextBg}"
  buffer.add fmt "parenText = {$theme.parenText}"
  buffer.add fmt "parenTextBg = {$theme.parenTextBg}"
  buffer.add fmt "currentWord = {$theme.currentWord}"
  buffer.add fmt "currentWordBg = {$theme.currentFileBg}"
  buffer.add fmt "highlightFullWidthSpace = {$theme.highlightFullWidthSpace}"
  buffer.add fmt "highlightFullWidthSpaceBg = {$theme.highlightFullWidthSpaceBg}"
  buffer.add fmt "highlightTrailingSpaces = {$theme.highlightTrailingSpaces}"
  buffer.add fmt "highlightTrailingSpacesBg = {$theme.highlightTrailingSpacesBg}"
  buffer.add fmt "workSpaceBar = {$theme.workSpaceBar}"
  buffer.add fmt "workSpaceBarBg = {$theme.workSpaceBarBg}"
  buffer.add fmt "reservedWord = {$theme.reservedWord}"
  buffer.add fmt "reservedWordBg = {$theme.reservedWordBg}"
  buffer.add fmt "currentSetting = {$theme.currentSetting}"
  buffer.add fmt "currentSettingBg = {$theme.currentSettingBg}"
  buffer.add fmt "currentLineBg = {$theme.currentLineBg}"
